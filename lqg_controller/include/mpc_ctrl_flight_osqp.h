...
const int n_mpc_states_ = 7;
const int mpcWindow_ = 15;
...
class LQRController : public rclcpp::Node
{
  ...
  Eigen::Matrix<double, 4, 1> ctrl_input_, last_ctrl_u_;
  ...
  OsqpEigen::Solver mpcSolver_;
  Eigen::VectorXd lb_;
  Eigen::VectorXd ub_;
  Eigen::DiagonalMatrix<double, n_mpc_states_> sys_Q_;
  Eigen::VectorXd gradient_;
  // allocate the constraints vector
  Eigen::Matrix<double, n_mpc_states_, 1> xMax_;
  Eigen::Matrix<double, n_mpc_states_, 1> xMin_;
  Eigen::Matrix<double, 4, 1> uMax_;
  Eigen::Matrix<double, 4, 1> uMin_;
  //int n_mpc_states_;
  //int mpcWindow_;
  ...
  public:
    ...
    bool getMPCSolution(Eigen::Vector4d &);
    void initMPCSystem();
};
